...
/// </summary>
[Prototype("Research")]
public sealed partial class HereticResearchPrototype : IPrototype
{
    /// <inheritdoc/>
    [IdDataField]
    ...
    /// </summary>
    [DataField(required: true)]
    public ProtoId<PathPrototype> Discipline;
    ...
    /// </summary>
    [DataField]
    public List<ProtoId<HereticResearchPrototype>> ResearchPrerequisites = new();

    /// <summary>
    /// A list of <see cref="LatheRecipePrototype"/>s that are unlocked by this technology
    /// </summary>
    [DataField]
    public List<ProtoId<UnlockResearchPrototype>> RecipeUnlocks = new();
